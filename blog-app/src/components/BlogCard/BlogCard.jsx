    ...
    return (
        <Card sx={{ maxWidth: 345, minHeight: 345 }}>
            ...
            <CardMedia
                ...
                height="194"
                image={
                    attributes.miniature.data?.attributes.formats.large?.url ||
                    attributes.miniature.data?.attributes.formats.medium?.url ||
                    attributes.miniature.data?.attributes.formats.small?.url ||
                    attributes.miniature.data?.attributes.formats.thumbnail?.url ||
